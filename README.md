...
<br></br>
<h1>Basic CMD Commands</h1>
The text files are used in cmd for fetching data have this given below:
<h3>sample.txt<h3>
<p>Hello, welcome to the command line.
This file is used for demonstrating the find command.  
The command line can be powerful for file manipulation.  
Enjoy learning!</p>

<h3>data.txt<h3>
<p>Apple. Banana. Cherry. Date. Elderberry. Fig. Gape.</p>

<h3>sorted_data.txt<h3>
<p>Apple. Banana. Cherry. Date. Elderberry. Fig. Gape.</p>
